...
:server
start /wait /abovenormal bin\plutonium-bootstrapper-win32.exe t6zm "%gamepath%" -dedicated +set zombiemode 1 +set key %key% +set fs_game %mod% +sv_config %cfg% +net_port %port% +map_rotate
